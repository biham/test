    ...
    <div class="card m-b-30">
        ...
        <div class="card-body">
            <div class="card-title">
                <h4 class="page-title text-center">Data Mahasiswa</h4>
...
<script>
    function datamahasiswa() {
        $.ajax({
            url: "<?= site_url('admin/mahasiswa/ambildata'); ?>",
            dataType: "json",
    ...
    $(document).ready(function() {
        ...
        $('.tomboltambah').click(function(e) {
            e.preventDefault();
            $.ajax({
                url: "<?= site_url('admin/mahasiswa/formtambah'); ?>",
                dataType: "json",
                success: function(response) {
        ...
        $('.tomboltambahbanyak').click(function(e) {
            e.preventDefault();
            $.ajax({
                url: "<?= site_url('admin/mahasiswa/formtambahbanyak'); ?>",
                dataType: "json",
                beforeSend: function() {
