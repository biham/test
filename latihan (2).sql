...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 28, 2022 at 12:50 PM
...
INSERT INTO `detail_bimbingan` (`id`, `id_judul`, `materi`, `files`, `files_2`, `ket`, `ket_2`, `paraf`, `status`) VALUES
(5, 54, 'BAB I', '2018000_Biham Maulana_1669242659_47f4c79ed9140ce995c3.docx', NULL, 'test data', 'perbaiki lagi penulisannya dan gambarnya', '', 1),
(25, 54, 'BAB II', '2018000_Biham Maulana_1669435647_4a5ff8b5014064248402.pdf', NULL, 'tesr', 'teszt', '', 1);
...
--
-- Constraints for table `detail_bimbingan`
--
ALTER TABLE `detail_bimbingan`
  ADD CONSTRAINT `detail_bimbingan_ibfk_1` FOREIGN KEY (`id_judul`) REFERENCES `proposal` (`id_judul`) ON DELETE CASCADE ON UPDATE CASCADE;
